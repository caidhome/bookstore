...
<form action="${pageContext.request.contextPath}/addBook"  name="f1" method="post"  onsubmit="return checkform();" enctype="multipart/form-data">
            						...
            						<table width="100%" border="0" cellspacing="0" cellpadding="0">
              							<tr>
                							...
                							<td width="95%" class="STYLE1">
                								<span class="STYLE3">你当前的位置</span>：添加图书
                							</td>
              							</tr>
            						</table>
            					</td>
        				...
        				<table style="margin-top:3px" width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#C3E5FB" >
          					<tr>
            					<td height="28" colspan="2" background="${pageContext.request.contextPath }/admin/tab/images/bg.gif" bgcolor="#FFFFFF">
            						<div align="center">
            							<span class="STYLE1">图 书 添 加</span>
            						</div>
            					</td>
            				</tr>
          					<tr>
            					...
            					<td width="83%" bgcolor="#FFFFFF" class="STYLE1">
            						<input type="text"  size='32' class='' name='name' id='tsname'/>
            						<label id='tsnamelab' />
            					</td>
          					</tr>
          					<tr>
            					...
            					<td width="83%" bgcolor="#FFFFFF" class="STYLE1">
            						<input type="text"  size='32' class='' name='price' id='tsprice' />
            						<label id='tspricelab' />
            					</td>
          					</tr>
							<tr>
							...
							<tr>
            					...
            					<td width="83%" bgcolor="#FFFFFF" class="STYLE1">
            						<input type="text" name="pnum" size="32" id='tsnum'/>
            						<label id='tsnumlab' />
            					</td>
          					</tr>
							<tr>
							...
							<tr>
            					...
            					<td width="83%" bgcolor="#FFFFFF" class="STYLE1">
            						<textarea rows="10" cols="35" name="description" id='tsdesc'></textarea>
									<label id='tsdesclab' />
								</td>
          					</tr>
        				</table>
...
<script type="text/javascript">
 	...
 	function checkform(){  
		...
		var tsimage = document.getElementById("tsimage");  
		if(tsimage.value==""){  
			document.getElementById("tsimagelab").innerHTML="&nbsp;&nbsp;<font color=red>请选择图书图片</font>";  
			return false;  
		}else{
			document.getElementById("tsimagelab").innerHTML="  ";  
		}  
